...
(lib.shivoklifinal3 = function(mode,startPosition,loop) {
	...
	this.reka.parent = this;
	this.reka.setTransform(256.6,173.4,1.071,1.079,0,0,0,0.1,0.1);
	...
	this.text = new cjs.Text("טיפים לעיצוב ושיווק", "bold 18px 'Assistant'", "#FF9900");
	this.text.textAlign = "right";
	this.text.lineHeight = 26;
	this.text.lineWidth = 193;
	this.text.parent = this;
	this.text.setTransform(305,20.3);
...
p.nominalBounds = new cjs.Rectangle(243,218.3,781,397.5);
// library properties:
lib.properties = {
	width: 550,
	height: 400,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/shivokli_final3_atlas_.png?1498765199844", id:"shivokli_final3_atlas_"}
	],
	preloads: []
};
